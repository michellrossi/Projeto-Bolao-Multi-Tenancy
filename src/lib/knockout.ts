...
export const KNOCKOUT_MATCHES: KnockoutMatch[] = [
  // FASE MATA-MATA — ordenada cronologicamente
  // 28/06
  ...
  { id: "O1", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M15", awayPlaceholder: "Vencedor Jogo M16", date: "2026-07-04", time: "18:00" }, // Paraguai vs França
  { id: "O2", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M13", awayPlaceholder: "Vencedor Jogo M14", date: "2026-07-04", time: "14:00" }, // Canadá vs Marrocos
  { id: "O3", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M5", awayPlaceholder: "Vencedor Jogo M6", date: "2026-07-06", time: "16:00" }, // Portugal vs Espanha
  { id: "O4", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M7", awayPlaceholder: "Vencedor Jogo M8", date: "2026-07-06", time: "21:00" }, // EUA vs Bélgica

  // Lado Direito (Chave 2)
  { id: "O5", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M9", awayPlaceholder: "Vencedor Jogo M10", date: "2026-07-05", time: "17:00" }, // Brasil vs Noruega
  { id: "O6", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M11", awayPlaceholder: "Vencedor Jogo M12", date: "2026-07-05", time: "21:00" }, // México vs Inglaterra
  { id: "O7", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M1", awayPlaceholder: "Vencedor Jogo M2", date: "2026-07-07", time: "13:00" }, // Egito vs Argentina
  { id: "O8", phase: "Oitavas", homePlaceholder: "Vencedor Jogo M3", awayPlaceholder: "Vencedor Jogo M4", date: "2026-07-07", time: "17:00" }, // Suíça vs Colômbia
