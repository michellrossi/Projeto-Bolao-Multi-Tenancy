...
begin
  ...
  -- 10. Membros Fictícios e Palpites para a Demo
  -- Inserir 8 usuários fictícios
  insert into public.users (id, email, display_name, photo_url)
  values 
    ('d0000000-0000-0000-0000-000000000001', 'carlos@demo.com', 'Carlos Silva', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Carlos'),
    ('d0000000-0000-0000-0000-000000000002', 'marina@demo.com', 'Marina Ruy', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Marina'),
    ('d0000000-0000-0000-0000-000000000003', 'roberto@demo.com', 'Roberto Baggio', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Roberto'),
    ('d0000000-0000-0000-0000-000000000004', 'ana@demo.com', 'Ana Clara', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Ana'),
    ('d0000000-0000-0000-0000-000000000005', 'bruno@demo.com', 'Bruno Gagliasso', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Bruno'),
    ('d0000000-0000-0000-0000-000000000006', 'juliana@demo.com', 'Juliana Paes', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Juliana'),
    ('d0000000-0000-0000-0000-000000000007', 'tiago@demo.com', 'Tiago Leifert', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Tiago'),
    ('d0000000-0000-0000-0000-000000000008', 'fernanda@demo.com', 'Fernanda Lima', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Fernanda')
  on conflict (id) do nothing;

  -- Adicionar usuários à liga demo
  insert into public.league_members (league_id, user_id, status)
  values 
    (demo_league_id, 'd0000000-0000-0000-0000-000000000001', 'approved'),
    (demo_league_id, 'd0000000-0000-0000-0000-000000000002', 'approved'),
    (demo_league_id, 'd0000000-0000-0000-0000-000000000003', 'approved'),
    (demo_league_id, 'd0000000-0000-0000-0000-000000000004', 'approved'),
    (demo_league_id, 'd0000000-0000-0000-0000-000000000005', 'approved'),
    (demo_league_id, 'd0000000-0000-0000-0000-000000000006', 'approved'),
    (demo_league_id, 'd0000000-0000-0000-0000-000000000007', 'approved'),
    (demo_league_id, 'd0000000-0000-0000-0000-000000000008', 'approved')
  on conflict do nothing;

  -- Adicionar resultados reais de alguns jogos (para o ranking ter pontos)
  insert into public.results (match_id, home_score, away_score)
  values 
    ('g1-1', 2, 0), -- Jogo de abertura (exemplo)
    ('g1-2', 1, 1),
    ('g2-1', 3, 0),
    ('g2-2', 0, 1)
  on conflict (match_id) do update set home_score = EXCLUDED.home_score, away_score = EXCLUDED.away_score;

  -- Adicionar palpites fictícios (alguns acertando, outros não)
  insert into public.predictions (league_id, user_id, match_id, home_score, away_score)
  values
    -- Carlos (Líder)
    (demo_league_id, 'd0000000-0000-0000-0000-000000000001', 'g1-1', 2, 0), -- Acertou placar
    (demo_league_id, 'd0000000-0000-0000-0000-000000000001', 'g1-2', 1, 1), -- Acertou placar
    -- Marina
    (demo_league_id, 'd0000000-0000-0000-0000-000000000002', 'g1-1', 1, 0), -- Acertou vencedor
    (demo_league_id, 'd0000000-0000-0000-0000-000000000002', 'g1-2', 2, 2), -- Acertou empate
    -- Roberto
    (demo_league_id, 'd0000000-0000-0000-0000-000000000003', 'g1-1', 0, 0), -- Errou
    (demo_league_id, 'd0000000-0000-0000-0000-000000000003', 'g1-2', 1, 1)  -- Acertou placar
  on conflict do nothing;
end;
$$;
